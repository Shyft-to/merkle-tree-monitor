...
const styles = tv({
  slots: {
    input: [
      "flex rounded-lg border-[2px] border-primary-300 py-2 px-3 text-base shadow-z1 bg-transparent",
      "placeholder:text-gray-500",
      "hover:border-primary-500",
      "focus:outline-none focus:ring-1 focus:border-primary-500 focus:border-primary-500",
